...
fn decomp_level(foreground: &mut Foreground) {
    terrain::decode_land(foreground.blocks_mut(), &[
        0x00, 0x0C, 0x04, 0x21, 0x62,
        0x20, 0x0E, 0x02, 0xD0, 0x62,
        0x20, 0x05, 0xB2, 0x62,
        0x3A, 0x09, 0x55, 0x62,
        0x50, 0x08, 0x25, 0x62,
        0x50, 0x0C, 0x64, 0x62,
        0x66, 0x03, 0x68, 0x62,
        //0x06, 0x0A, 0x0A, 0x0C, 0x00
    ]);
    terrain::decode_chunk(vec2(0, 0), foreground.blocks_mut(), &[0x01, 0xA7, 0x51, 0x01, 0xA5, 0x52, 0x01, 0xF7, 0x12]);
